...
static void test_addss(void)
{
    ...
    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 1000.0f, -2750.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], -1750.0, FLOAT_ERROR_MARGIN);

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, -1210.0f, 2000.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], 790.0, FLOAT_ERROR_MARGIN);

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, -30.7f, -50.5f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], -81.2, FLOAT_ERROR_MARGIN);

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 0.0f, 0.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], 0.0, FLOAT_ERROR_MARGIN);

    // NaN
    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, nanf(""), -2.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_TRUE(isnan(rvals[0]));

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 1.0f, nanf(""));
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_TRUE(isnan(rvals[0]));

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, nanf(""), nanf(""));
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_TRUE(isnan(rvals[0]));
}
...
static void test_subss(void)
{
    ...
    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 300.0f, -2250.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    ...
    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, -3.5f, -5.7f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
...
static void test_mulss(void)
{
    ...
    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 4.0f, 2.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], 8.0, FLOAT_ERROR_MARGIN);

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 300.0f, -2.5f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    ...
    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 5.0f, 1.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], 5.0, FLOAT_ERROR_MARGIN);

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 5.0f, 0.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], 0.0, FLOAT_ERROR_MARGIN);
...
static void test_modss(void)
{
    ...
    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 3.0f, 2.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], 1.0, FLOAT_ERROR_MARGIN);

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 300.0f, 100.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], 0.0, FLOAT_ERROR_MARGIN);

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, -5.1f, 3.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    ...
    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 1.0f, -3.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], 1.0, FLOAT_ERROR_MARGIN);

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 2.5f, 1.4f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], 1.1, FLOAT_ERROR_MARGIN);

    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 0.0f, 3.5f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_DOUBLE_EQUAL(rvals[0], 0.0, FLOAT_ERROR_MARGIN);

    // NaN
    TEST_UPDATE_ARGS(ctx, def, (lmnt_offset)0, 3.0f, 0.0f);
    CU_ASSERT_EQUAL(lmnt_execute(ctx, def, rvals, (lmnt_offset)rvals_count), rvals_count);
    CU_ASSERT_TRUE(isnan(rvals[0]));
