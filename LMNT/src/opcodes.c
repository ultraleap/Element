...
const lmnt_op_info lmnt_opcode_info[LMNT_OP_END] = {
    ...
    { "ASSIGNCEQ", LMNT_OPERAND_IMM,      LMNT_OPERAND_IMM,      LMNT_OPERAND_STACK1   },
    { "ASSIGNCNE", LMNT_OPERAND_IMM,      LMNT_OPERAND_IMM,      LMNT_OPERAND_STACK1   },
    { "ASSIGNCLT", LMNT_OPERAND_IMM,      LMNT_OPERAND_IMM,      LMNT_OPERAND_STACK1   },
    { "ASSIGNCLE", LMNT_OPERAND_IMM,      LMNT_OPERAND_IMM,      LMNT_OPERAND_STACK1   },
    { "ASSIGNCGT", LMNT_OPERAND_IMM,      LMNT_OPERAND_IMM,      LMNT_OPERAND_STACK1   },
    { "ASSIGNCGE", LMNT_OPERAND_IMM,      LMNT_OPERAND_IMM,      LMNT_OPERAND_STACK1   },
    { "ASSIGNCUN", LMNT_OPERAND_IMM,      LMNT_OPERAND_IMM,      LMNT_OPERAND_STACK1   },
