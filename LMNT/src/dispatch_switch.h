...
//        case LMNT_OP_REMVV:     opresult = lmnt_op_remvv(ctx, op.arg1, op.arg2, op.arg3); break;
        case LMNT_OP_SINR:       opresult = lmnt_op_sinr(ctx, op.arg1, op.arg2, op.arg3); break;
        case LMNT_OP_COSR:       opresult = lmnt_op_cosr(ctx, op.arg1, op.arg2, op.arg3); break;
        case LMNT_OP_TANR:       opresult = lmnt_op_tanr(ctx, op.arg1, op.arg2, op.arg3); break;
        case LMNT_OP_ASINR:      opresult = lmnt_op_asinr(ctx, op.arg1, op.arg2, op.arg3); break;
        case LMNT_OP_ACOSR:      opresult = lmnt_op_acosr(ctx, op.arg1, op.arg2, op.arg3); break;
        case LMNT_OP_ATANR:      opresult = lmnt_op_atanr(ctx, op.arg1, op.arg2, op.arg3); break;
        case LMNT_OP_ATAN2R:     opresult = lmnt_op_atan2r(ctx, op.arg1, op.arg2, op.arg3); break;
        case LMNT_OP_SINCOSR:    opresult = lmnt_op_sincosr(ctx, op.arg1, op.arg2, op.arg3); break;
