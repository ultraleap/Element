...
{
    public sealed class ListStructImplementation : IntrinsicStructImplementation
    {
        ...
        private ListStructImplementation()
        {
            Identifier = new Identifier("List");
        }

        public static ListStructImplementation Instance { get; } = new ListStructImplementation();
        ...
        public static Result<int> ConstantCount(StructInstance listInstance, CompilationContext context) =>
            listInstance.DeclaringStruct.IsIntrinsic<ListStructImplementation>()
