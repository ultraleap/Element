...
#pragma warning restore 649, 169
        ...
        public override IValue ResolveExpression(IScope scope, CompilationContext compilationContext) => new AnonymousFunction(scope, _body, _portList, Port.ReturnPort(_type));
    }
}