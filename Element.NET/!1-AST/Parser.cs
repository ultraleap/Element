...
namespace Element.AST
{
    ...
    public static class Parser
    {
        ...
        public static Result<T> Parse<T>(SourceInfo source, Context context, bool noParseTrace = false) where T : notnull
        {
            ...
            if (noParseTrace) return context.Trace(ElementMessage.ParseError, $"Parsing failed within source '{source.FullName}' - enable parse trace and run again for details.");
            ...
            return context.Trace(ElementMessage.ParseError, $"Parsing failed within '{source.DisplayName}' - see parse trace below for details.\n{sb}");
        }
        ...
        public static void Validate(this Identifier identifier, ResultBuilder builder, Identifier[] blacklist, Identifier[] whitelist)
        {
            ...
            {
                builder.Append(ElementMessage.InvalidIdentifier, "Null or empty identifier is invalid");
            }
            ...
            {
                builder.Append(ElementMessage.InvalidIdentifier, $"'{identifier}' is a reserved identifier");
            }
        }
    }
