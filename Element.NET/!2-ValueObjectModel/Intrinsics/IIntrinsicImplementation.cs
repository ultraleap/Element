...
namespace Element.AST
{
    public abstract class IntrinsicValue : Value, IIntrinsicValue, IIntrinsicImplementation
    {
        ...
        public override bool IsIntrinsicOfType<TIntrinsicImplementation>() => this is TIntrinsicImplementation;
        public override bool IsSpecificIntrinsic(IIntrinsicImplementation intrinsic) => this == intrinsic;
    }
    ...
    {
        public abstract Result MatchesConstraint(IValue value, Context context);
    }
    ...
    public interface IIntrinsicStructImplementation : IIntrinsicImplementation
    {
        ...
        public abstract Result MatchesConstraint(Struct @struct, IValue value, Context context);
    }
}