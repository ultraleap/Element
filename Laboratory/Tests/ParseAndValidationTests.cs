    ...
    internal class ParseAndValidationTests : HostFixture
    {
        ...
        private static IEnumerable PartialSyntaxTestData()
        {
            var data = new[]
            {
                ...
                ($"{nameof(FunctionDeclaration)}-ExpressionBody", "a(a):Num = 5;", typeof(FunctionDeclaration)),
                ($"{nameof(FunctionDeclaration)}-ScopeBody", "a(a):Num {return = 5;}", typeof(FunctionDeclaration)),
                ...
                (nameof(StructDeclaration), "struct a(a);", typeof(StructDeclaration)),
                ($"{nameof(StructDeclaration)}-WithScope", "struct a(a) {}", typeof(StructDeclaration)),
