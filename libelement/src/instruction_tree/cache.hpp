...
private:
    ...
    {
        const bool skip_caching = instruction->is<instruction_constant>() || instruction->is<instruction_input>() || instruction->is<instruction_serialised_structure>() || instruction->is<instruction_for>();
